        ...
        <div className="post">
            ...
            <div className="post__author">
                <svg
                    ...
                    onClick={() => handleClick()}
                    style={{ fill: active ? "#0CAFFF" : "white" }}
                >
                    <path fillRule="evenodd" d="M2,228.5a19,19 0 01 19-19h91a19,19 0 01 19,19v201a19,19 0 01-19,19h-91a19,19 0 01-19-19zM41.5,389.5a20,20 0 01 40.5,0a20,20 0 01-40.5,0z" />
